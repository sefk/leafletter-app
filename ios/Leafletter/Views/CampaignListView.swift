...
private struct BetaBannerView: View {
    var body: some View {
        Text("**Beta:** This app is in beta. If you have feedback or concerns, please [file a bug](https://github.com/sefk/leafletter-app/issues/) or email us at info@leafletter.app.")
            .font(.caption)
