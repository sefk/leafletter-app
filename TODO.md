...
### 1. [P0] Campaign map: bounding box from cities; enforce zoom limits
...
### 2. [P0] Trip selection: block-level granularity, not whole streets
...
### 3. [P0] Trip UX: improve block selection flow
...
### 4. [P0] Bug: multiple trips overwrite each other
...
### 5. [P1] Campaign manager UI: replace Django Admin with a purpose-built interface
...
### 6. [P1] City search: disambiguate cities with the same name
...
### 7. [P2] Landing page: show list of published campaigns instead of admin redirect
